...
namespace DIY4UMazeGame.GameEngine.GameInfo.Items.ItemObject
{
    ...
    public class Gold : Item, IStationary, IPrintable, ICarryable, IDropable, IHasPrice, ITakable,
         IAvailable
    {
        ...
        public ConsoleColor ItemColor { get; set; } = ConfigManager.GoldColor;
        public int Price { get; set; } = 0;

        //Construtor
        public Gold(string itemname_in, string descriptions_in, int col_in, int row_in, string key)
        {
            ...
            Price = 3;
            itemtype = ITEM_TYPE.Gold;
            IconChar = ConfigManager.GoldIcon;
        }

        public Gold(string descriptions_in, int col_in, int row_in, string key)
        {
            itemname = "Gold";
            descriptions = descriptions_in;
            col = col_in;
