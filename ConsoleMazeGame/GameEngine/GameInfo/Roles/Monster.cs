...
namespace DIY4UMazeGame.GameEngine.GameInfo.Roles
{
    ...
    public class Monster : Enemy, ILivingOrganism, IPrintable, IStationary, IMovable, ITakable
    {
        ...
        public ConsoleColor ItemColor { get; set; } = ConfigManager.MonsterColor;
        ...
        private int explore_distance = ConfigManager.RandomGen.Next(10,40);
        private int retreat_distance = ConfigManager.RandomGen.Next(1,20);

        private GameWorldInfo gwinfo = null;
        private RoomMap roommap = null;

        public Monster(int col_in, int row_in, string key,RoomMap roommapin)
        {
            instanceNo++;
            InstanceName = "Monster-" + instanceNo;
            col = col_in;
            row = row_in;
            InstanceKey = key;
            ...
            EnemyType = ENEMY_TYPE.MONSTER;

            IconChar = ConfigManager.MonsterIcon;
        ...
        private void Engine()
        {
            ...
            Object item = null;
            /*
            GameWorldInfo gwinfo = GameDataFactory.CreateInitialWorldData();
            RoomMap roommap = gwinfo.GetGameRoombyNumber(GameState.currentRoom).Room_Map;
            */
            gwinfo = GameDataFactory.curr_gwinfo;
            //roommap = gwinfo.GetGameRoombyNumber(GameState.currentRoom).Room_Map;
            int step_forward = 0;
